# 👋 E aí, eu sou o Glauco

💻 **Senior Software Engineer | Backend | Distributed Systems**
🚀 Apaixonado por arquitetura, performance e sistemas que escalam de verdade.
...
## 🧩 Boss fights que já enfrentei

* ⚔️ Microsserviços com consistência de dados entre serviços
* ⚔️ Mensageria assíncrona em alto volume
* ⚔️ CI/CD + observabilidade para sistemas críticos
* ⚔️ Hotfix em produção sem downtime
* ⚔️ Otimização pesada de SQL e performance
* ⚔️ Regras de negócio complexas de fintech/marketplace
...
⭐ Sempre aberto a conversar sobre **arquitetura, Go, sistemas distribuídos e engenharia de verdade**.
